...
def self_outside_priming(summarized, speakers, avg_utterance_length, file):
    #TODO: Plot each point instead of just the averages for each file to see what happens
    # Semantic vs syntactic vs cognate priming --> Strength of each of those in regards to codeswitching
